...
export default function PSPsPage() {
  ...
  const canCreate = user ? hasPermission(user.role, "create_psp") : false;
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-slate-900">PSPs</h1>
        <p className="mt-1 text-sm text-slate-500">
          Create, submit, and manage PSPs. Use tabs to filter by status.
        </p>
      </div>
